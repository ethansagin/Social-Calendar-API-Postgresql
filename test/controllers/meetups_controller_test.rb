...
class MeetupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meetup" do
    assert_difference('Meetup.count') do
      post meetups_url, params: { meetup: { comments: @meetup.comments, date: @meetup.date, friend_id: @meetup.friend_id, location: @meetup.location, time: @meetup.time } }, as: :json
    end
  ...
  test "should update meetup" do
    patch meetup_url(@meetup), params: { meetup: { comments: @meetup.comments, date: @meetup.date, friend_id: @meetup.friend_id, location: @meetup.location, time: @meetup.time } }, as: :json
    assert_response 200
  end
